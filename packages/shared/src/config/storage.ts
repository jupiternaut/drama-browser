...
/**
 * Load config defaults from ~/.drama-agent/config-defaults.json
...
export function ensureConfigDir(): void {
  ...
  // Initialize bundled docs (creates ~/.drama-agent/docs/ with sources.md, agents.md, permissions.md)
  initializeDocs();
...
/**
 * Get the path to the app-level theme override file (~/.drama-agent/theme.json).
 */
 ...
 * Preset themes are stored at ~/.drama-agent/themes/
 */
...
/**
 * Returns the path to the tool-icons directory: ~/.drama-agent/tool-icons/
 */
